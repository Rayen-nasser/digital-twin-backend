...
SECRET_KEY = 'django-insecure-v$tx2_t*ez+7mkxylx))c#lxc3q2+j#jj2^@!kv=s8ul*nc5h@'
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': 'su$t+&e#i1z4*bl4xj2fp*smu=$r6u1+v7wznf7w=05z',  # Replace with your Django SECRET_KEY or a dedicated JWT key
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
    ...
    # Custom claims - can be used to send additional data in token
