# Generated by Django 4.1.13 on 2025-04-14 17:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ai_settings', models.JSONField(default=core.models.User.get_default_ai_settings)),
            ],
            options={
                'verbose_name': 'User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('communication_style', models.JSONField(default=core.models.Twin.get_default_communication_style)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['twin_id'], name='twin_idx'),
        ),
        migrations.AddIndex(
            model_name='chathistory',
        ...
        migrations.AddIndex(
            model_name='authtoken',
            index=models.Index(fields=['token'], name='core_authto_token_434c69_idx'),
        ),
        migrations.AddIndex(
            model_name='authtoken',
            index=models.Index(fields=['expires_at'], name='core_authto_expires_713117_idx'),
        ),
    ]
